...
- **Buttons**: Action verbs — "Save changes", "Create tour", "Delete account". Never "Submit" or "OK".
- **Toasts**: Under 10 words. Success: confirm. Error: what happened + what to do.
- **Empty states**: Explain what this area is for + CTA to fill it. ("No tours yet. Create your first tour.")
