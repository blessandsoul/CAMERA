...
images:
  - "Untitled-826.png"
name:
  ka: Dahua IP კამერა 4MP Full-color Fixed-focal Dome
...
specs:
  ...
  - key: { ka: "ადამიანის და ავტომობილის სილუეტის ამოცნობა", en: "Human & Vehicle Detection", ru: "Распознавание людей и авто" }
    value: "კი"
createdAt: "2026-02-16T21:55:02.872Z"
---

Dahua IP კამერა 4MP Full-color Fixed-focal Dome. შიდა გამოყენების გამოყენება. რეზოლუცია: 4 მპ. ლინზა: 2.8 მმ.
