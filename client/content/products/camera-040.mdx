---
id: camera-040
slug: ezviz-3-outdoor-camera-2-8
category: cameras
price: 79
currency: GEL
isActive: true
...
images:
  - "Ezviz-CB3.webp"
name:
  ka: სამეთვალყურეო კამერა, Ezviz CB3
  ru: Ezviz 3 მპ уличная камера 2.8 მმ
  en: Ezviz 3 მპ outdoor Camera 2.8 მმ
specs:
  ...
  - key: { ka: "ადამიანის და ავტომობილის სილუეტის ამოცნობა", en: "Human & Vehicle Detection", ru: "Распознавание людей и авто" }
    value: "კი"
createdAt: "2026-02-17T05:55:02.868Z"
---

სამეთვალყურეო კამერა, Ezviz CB3. გარე გამოყენების გამოყენება. რეზოლუცია: 3 მპ. ლინზა: 2.8 მმ.
