---
id: camera-058
slug: dahua-5-indoor-camera-2-8
category: cameras
price: 149
currency: GEL
isActive: true
...
images:
  - "Untitled-794.png"
name:
  ka: Dahua IP კამერა 5MP Full-color Fixed-focal Eyeball
  ru: Dahua 5 მპ внутренняя камера 2.8 მმ
  en: Dahua 5 მპ indoor Camera 2.8 მმ
specs:
  ...
  - key: { ka: "ადამიანის და ავტომობილის სილუეტის ამოცნობა", en: "Human & Vehicle Detection", ru: "Распознавание людей и авто" }
    value: "კი"
createdAt: "2026-02-16T11:55:02.877Z"
---

Dahua IP კამერა 5MP Full-color Fixed-focal Eyeball. შიდა გამოყენების გამოყენება. რეზოლუცია: 5 მპ. ლინზა: 2.8 მმ.
