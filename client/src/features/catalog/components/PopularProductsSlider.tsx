...
export function PopularProductsSlider({ products, locale, title, subtitle }: PopularProductsSliderProps): ReactElement | null {
...
function SliderCard({ product, locale }: { product: Product; locale: Locale }): ReactElement {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {isService ? (
          <span className="text-sm text-muted-foreground italic">შეკვეთით</span>
        ) : (
