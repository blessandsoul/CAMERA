  ...
  return (
    <div className="flex items-center gap-3 w-full">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 h-10 px-5 rounded-xl bg-primary text-primary-foreground text-sm font-semibold transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 hover:brightness-110 active:scale-[0.98] shrink-0"
      >
        {t('catalog.buy_now')}
