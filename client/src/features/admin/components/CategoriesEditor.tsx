              ...
              <div className="flex items-center gap-2 px-4 py-2 hover:bg-muted/50 transition-colors">
                ...
                {cat.id !== 'all' && (
                  <div className="flex items-center gap-0.5 shrink-0">
                    ...
                    <Button type="button" variant="ghost" size="icon-xs" onClick={() => removeCategory(catIdx)} aria-label="კატეგორიის წაშლა" className="text-muted-foreground hover:text-destructive">
                    ...
                    <div className="space-y-1 mt-2">
                      ...
                      {cat.children.map((child, childIdx) => (
                        <div key={child.id} className="grid grid-cols-6 gap-1.5 items-center py-1">
                          ...
                          <Button type="button" variant="ghost" size="icon-xs" onClick={() => removeSubcategory(catIdx, childIdx)} className="text-muted-foreground hover:text-destructive justify-self-start" aria-label="წაშლა">
