              ...
              <div className="flex items-center gap-3">
                {settings.social.facebook && (
                  <a
                    ...
                    aria-label="Facebook"
                    className="w-9 h-9 flex items-center justify-center rounded-lg border border-border/60 text-muted-foreground hover:text-primary hover:border-primary/40 hover:bg-primary/5 transition-all duration-200 cursor-pointer"
                  >
