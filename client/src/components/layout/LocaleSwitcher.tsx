  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg hover:bg-accent transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
      >
        <current.Flag />
        ...
        >
          {LOCALES.map((l) => (
            <button
              ...
              className={cn(
                'w-full flex items-center gap-2.5 px-3 py-2.5 text-xs font-semibold transition-colors duration-150 cursor-pointer',
                locale === l.code
