...
function CarouselD({ products, locale, currentIndex, onNavigate }: {
    ...
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
      <div className="space-y-5 max-w-2xl">
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
          ...
          <motion.div className="flex flex-wrap items-center gap-3 min-h-14 content-start" layout>
      ...
      <div className="relative animate-in fade-in slide-in-from-right-4 duration-700 delay-300">
        ...
        <CarouselD products={products} locale={locale} currentIndex={currentIndex} onNavigate={handleNavigate} />
      </div>
    </div>
  );
}
